...
async function getTitleFromIMDb(imdbId) {
    try {
        ...
        console.log(`[DEBUG] 🇳️ VAR RES: ${res}`);
        console.log(`[DEBUG] 🇳️ VAR titleRaw: ${titleRaw}`);
        console.log(`[DEBUG] 🇳️ VAR title: ${title}`);
...
async function searchTorrents(query) {
    ...
    try {
        ...
        console.error(`[ERROR] Vyhľadávanie zlyhalo: '${res}' `);
        return [];
    }
}
